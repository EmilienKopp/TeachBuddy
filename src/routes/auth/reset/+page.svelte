            ...
            <form class="space-y-3 grid grid-cols-1 gap-2 font-raleway" method="POST" use:enhance>
                    ...
                    <Label for="show-password2" class="md:text-xl tracking-wide">Confirm・確認
                        ...
                        <InputAddon>
                            ...
                            <Input id="show-password2" bind:value={$form.password_confirm} type={showPassword ? 'text' : 'password'} name="password_confirm" placeholder="Your password here" {...$constraints.password_confirm}/>
